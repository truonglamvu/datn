            ...
            <div class="panel panel-red">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge">{{ $count_permission }}</div>
                            <div>Permission!</div>
                        </div>
                    </div>
                </div>
                <a href="#">
                    <div class="panel-footer">
                        <span class="pull-left">View Details</span>
                        <a href="{{ route('permission.index') }}" class="pull-right"><i class="fa fa-arrow-circle-right"></i></a>
                        <div class="clearfix"></div>
                    </div>
                </a>
            </div>
